...
def pycaes_test_crypt_cbc(
    mode, key, initialization_vector, input_data, expected_output_data):
...
def main():
  ...
  print("Testing AES-CBC 128-bit decryption\t"),
  result = True

  for test_index in range(0, 128):
    test_key = bytes(bytearray(key[:16]))
    test_initialization_vector = bytes(bytearray(initialization_vector))
    test_cipher_text = bytes(bytearray(cipher_texts1_128bit[test_index]))
    test_plain_text = bytes(bytearray(plain_texts1[test_index]))

    result = pycaes_test_crypt_cbc(
        pycaes.crypt_modes.DECRYPT, test_key, test_initialization_vector,
  ...
  for test_index in range(0, 128):
    test_key = bytes(bytearray(keys[test_index][:16]))
    test_initialization_vector = bytes(bytearray(initialization_vector))
  ...
  print("Testing AES-CBC 192-bit decryption\t"),
  result = True

  for test_index in range(0, 128):
    test_key = bytes(bytearray(key[:24]))
    test_initialization_vector = bytes(bytearray(initialization_vector))
    test_cipher_text = bytes(bytearray(cipher_texts1_192bit[test_index]))
    test_plain_text = bytes(bytearray(plain_texts1[test_index]))
  ...
  for test_index in range(0, 128):
    test_key = bytes(bytearray(keys[test_index][:24]))
    test_initialization_vector = bytes(bytearray(initialization_vector))
    test_cipher_text = bytes(bytearray(cipher_texts2_192bit[test_index]))
    test_plain_text = bytes(bytearray(plain_text))
  ...
  print("Testing AES-CBC 256-bit decryption\t"),
  result = True

  for test_index in range(0, 128):
    test_key = bytes(bytearray(key))
    test_initialization_vector = bytes(bytearray(initialization_vector))
    test_cipher_text = bytes(bytearray(cipher_texts1_256bit[test_index]))
    test_plain_text = bytes(bytearray(plain_texts1[test_index]))
  ...
  for test_index in range(0, 128):
    test_key = bytes(bytearray(keys[test_index]))
    test_initialization_vector = bytes(bytearray(initialization_vector))
    test_cipher_text = bytes(bytearray(cipher_texts2_256bit[test_index]))
    test_plain_text = bytes(bytearray(plain_text))
