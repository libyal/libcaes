/*
 * Library AES-ECB de/encryption testing program
 *
     ...
     size_t expected_output_data_size )
{
	...
	static char *function      = "caes_test_crypt_ecb";
...
#endif
{
	...
	fprintf(
	 stdout,
	 "Testing AES-ECB 128-bit decryption\t" );

	for( test_index = 0;
	     test_index < 128;
	     test_index++ )
	{
		result = caes_test_crypt_ecb(
		...
		if( result == -1 )
		{
			fprintf(
			 stderr,
			 "Unable to test AES-ECB 128-bit decryption.\n" );
	...
	fprintf(
	 stdout,
	 "Testing AES-ECB 192-bit decryption\t" );
	     ...
	     test_index++ )
	{
		...
		if( result == -1 )
		{
			fprintf(
			 stderr,
			 "Unable to test AES-ECB 192-bit decryption.\n" );
	...
	fprintf(
	 stdout,
	 "Testing AES-ECB 256-bit decryption\t" );
	     ...
	     test_index++ )
	{
		...
		if( result == -1 )
		{
			fprintf(
			 stderr,
			 "Unable to test AES-ECB 256-bit decryption.\n" );
	...
	fprintf(
	 stdout,
	 "Testing AES-ECB 128-bit encryption\t" );
	     ...
	     test_index++ )
	{
		...
		if( result == -1 )
		{
			fprintf(
			 stderr,
			 "Unable to test AES-ECB 128-bit encryption.\n" );
	...
	fprintf(
	 stdout,
	 "Testing AES-ECB 192-bit encryption\t" );
	     ...
	     test_index++ )
	{
		...
		if( result == -1 )
		{
			fprintf(
			 stderr,
			 "Unable to test AES-ECB 192-bit encryption.\n" );
	...
	fprintf(
	 stdout,
	 "Testing AES-ECB 256-bit encryption\t" );
	     ...
	     test_index++ )
	{
		...
		if( result == -1 )
		{
			fprintf(
			 stderr,
			 "Unable to test AES-ECB 256-bit encryption.\n" );
