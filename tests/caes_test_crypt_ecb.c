...
struct caes_test_vector_128bit
{
	/* Key data
	 */
	uint8_t key_data[ 16 ];
...
typedef struct caes_test_vector_192bit caes_test_vector_192bit_t;

struct caes_test_vector_192bit
{
	/* Key data
	 */
	uint8_t key_data[ 24 ];
 ...
 * ECBVarKey128.rsp.rsp
 */
caes_test_vector_128bit_t caes_crypt_ecb_decryption_test_vectors_128bit[ 128 ] = {
...
caes_test_vector_128bit_t caes_crypt_ecb_encryption_test_vectors_128bit[ 128 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0x0e, 0xdd, 0x33, 0xd3, 0xc6, 0x21, 0xe5, 0x46, 0x45, 0x5b, 0xd8, 0xba, 0x14, 0x18, 0xbe, 0xc8 },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
        { { 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
...
/* Values from NIST Cryptographic Algorithm Validation Program (CAVP)
 * ECBVarKey192.rsp.rsp
 */
caes_test_vector_192bit_t caes_crypt_ecb_decryption_test_vectors_192bit[ 192 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
caes_test_vector_192bit_t caes_crypt_ecb_encryption_test_vectors_192bit[ 192 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0xde, 0x88, 0x5d, 0xc8, 0x7f, 0x5a, 0x92, 0x59, 0x40, 0x82, 0xd0, 0x2c, 0xc1, 0xe1, 0xb4, 0x2c },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
...
/* Values from NIST Cryptographic Algorithm Validation Program (CAVP)
 * ECBVarKey256.rsp.rsp
 */
caes_test_vector_256bit_t caes_crypt_ecb_decryption_test_vectors_256bit[ 256 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
...
caes_test_vector_256bit_t caes_crypt_ecb_encryption_test_vectors_256bit[ 256 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0xe3, 0x5a, 0x6d, 0xcb, 0x19, 0xb2, 0x01, 0xa0, 0x1e, 0xbc, 0xfa, 0x8a, 0xa2, 0x2b, 0x57, 0x59 },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
 ...
 * Returns 1 if successful, 0 if not or -1 on error
 */
int caes_test_crypt_ecb_decryption_128bits(
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_128bit = &( caes_crypt_ecb_decryption_test_vectors_128bit[ test_index ] );

		result = caes_test_crypt_ecb(
		          LIBCAES_CRYPT_MODE_DECRYPT,
		          test_vector_128bit->key_data,
		          128,
 ...
 * Returns 1 if successful, 0 if not or -1 on error
 */
int caes_test_crypt_ecb_encryption_128bits(
     void )
{
	caes_test_vector_128bit_t *test_vector_128bit = NULL;
	int result                                    = 0;
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_128bit = &( caes_crypt_ecb_encryption_test_vectors_128bit[ test_index ] );
 ...
 * Returns 1 if successful, 0 if not or -1 on error
 */
int caes_test_crypt_ecb_decryption_192bits(
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_192bit = &( caes_crypt_ecb_decryption_test_vectors_192bit[ test_index ] );

		result = caes_test_crypt_ecb(
		          LIBCAES_CRYPT_MODE_DECRYPT,
		          test_vector_192bit->key_data,
		          192,
 ...
 * Returns 1 if successful, 0 if not or -1 on error
 */
int caes_test_crypt_ecb_encryption_192bits(
     void )
{
	caes_test_vector_192bit_t *test_vector_192bit = NULL;
	int result                                    = 0;
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_192bit = &( caes_crypt_ecb_encryption_test_vectors_192bit[ test_index ] );
 ...
 * Returns 1 if successful, 0 if not or -1 on error
 */
int caes_test_crypt_ecb_decryption_256bits(
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_256bit = &( caes_crypt_ecb_decryption_test_vectors_256bit[ test_index ] );
 ...
 * Returns 1 if successful, 0 if not or -1 on error
 */
int caes_test_crypt_ecb_encryption_256bits(
     void )
{
	caes_test_vector_256bit_t *test_vector_256bit = NULL;
	int result                                    = 0;
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_256bit = &( caes_crypt_ecb_encryption_test_vectors_256bit[ test_index ] );
...
#endif
{
	...
	if( caes_test_crypt_ecb_decryption_128bits() != 1 )
	{
		return( EXIT_FAILURE );
	}
	if( caes_test_crypt_ecb_encryption_128bits() != 1 )
	{
		return( EXIT_FAILURE );
	}
	if( caes_test_crypt_ecb_decryption_192bits() != 1 )
	{
		return( EXIT_FAILURE );
	}
	if( caes_test_crypt_ecb_encryption_192bits() != 1 )
	{
		return( EXIT_FAILURE );
	}
	if( caes_test_crypt_ecb_decryption_256bits() != 1 )
	{
		return( EXIT_FAILURE );
	}
	if( caes_test_crypt_ecb_encryption_256bits() != 1 )
	{
		return( EXIT_FAILURE );
	}
	return( EXIT_SUCCESS );
