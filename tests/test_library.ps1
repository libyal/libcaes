...
$LibraryTests = "context error key support tweaked_context"
...
Function RunTest
{
	...
	$TestExecutable = "${TestToolDirectory}\caes_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libcaes"
