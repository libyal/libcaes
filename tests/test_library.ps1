...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$ResultRun = RunTestBinary ${TestExecutablesDirectory} "caes_test_${TestName}"
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$ResultRun = RunTestBinaryWithInput ${TestExecutablesDirectory} "caes_test_${TestName}" ${TestInput}
