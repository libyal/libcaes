...
struct caes_test_vector_128bit
{
	 ...
	 */
	uint8_t initializiation_vector_data[ 16 ];
 ...
 * CBCVarKey128.rsp
 */
caes_test_vector_128bit_t caes_crypt_cbc_decryption_test_vectors_128bit[ 128 ] = {
...
caes_test_vector_128bit_t caes_crypt_cbc_encryption_test_vectors_128bit[ 128 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0x0e, 0xdd, 0x33, 0xd3, 0xc6, 0x21, 0xe5, 0x46, 0x45, 0x5b, 0xd8, 0xba, 0x14, 0x18, 0xbe, 0xc8 },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
 ...
 * CBCVarKey192.rsp
 */
caes_test_vector_192bit_t caes_crypt_cbc_decryption_test_vectors_192bit[ 192 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
caes_test_vector_192bit_t caes_crypt_cbc_encryption_test_vectors_192bit[ 192 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0xde, 0x88, 0x5d, 0xc8, 0x7f, 0x5a, 0x92, 0x59, 0x40, 0x82, 0xd0, 0x2c, 0xc1, 0xe1, 0xb4, 0x2c },
 ...
 * CBCVarKey256.rsp
 */
caes_test_vector_256bit_t caes_crypt_cbc_decryption_test_vectors_256bit[ 256 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
...
caes_test_vector_256bit_t caes_crypt_cbc_encryption_test_vectors_256bit[ 256 ] = {
        { { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
          { 0xe3, 0x5a, 0x6d, 0xcb, 0x19, 0xb2, 0x01, 0xa0, 0x1e, 0xbc, 0xfa, 0x8a, 0xa2, 0x2b, 0x57, 0x59 },
     ...
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_128bit = &( caes_crypt_cbc_decryption_test_vectors_128bit[ test_index ] );

		result = caes_test_crypt_cbc(
		          LIBCAES_CRYPT_MODE_DECRYPT,
		          test_vector_128bit->key_data,
		          128,
		          test_vector_128bit->initializiation_vector_data,
		          16,
     ...
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_128bit = &( caes_crypt_cbc_encryption_test_vectors_128bit[ test_index ] );
     ...
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_192bit = &( caes_crypt_cbc_decryption_test_vectors_192bit[ test_index ] );

		result = caes_test_crypt_cbc(
		          LIBCAES_CRYPT_MODE_DECRYPT,
		          test_vector_192bit->key_data,
		          192,
		          test_vector_192bit->initializiation_vector_data,
		          16,
     ...
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_192bit = &( caes_crypt_cbc_encryption_test_vectors_192bit[ test_index ] );
     ...
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_256bit = &( caes_crypt_cbc_decryption_test_vectors_256bit[ test_index ] );

		result = caes_test_crypt_cbc(
		          LIBCAES_CRYPT_MODE_DECRYPT,
		          test_vector_256bit->key_data,
		          256,
		          test_vector_256bit->initializiation_vector_data,
		          16,
     ...
     void )
{
	...
	for( test_index = 0;
	     ...
	     test_index++ )
	{
		test_vector_256bit = &( caes_crypt_cbc_encryption_test_vectors_256bit[ test_index ] );
