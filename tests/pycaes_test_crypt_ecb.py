...
def pycaes_test_crypt_ecb(mode, key, input_data, expected_output_data):
...
def main():
  # Values from NIST KAT-AES ECBVarKey128.rsp, ECBVarKey192.rsp and ECBVarKey256.rsp
  keys = [
  ...
  # Values from NIST KAT-AES ECBVarTxt128.rsp
  ...
  # Values from NIST KAT-AES ECBVarKey128.rsp
  ...
  # Values from NIST KAT-AES ECBVarTxt192.rsp
  ...
  # Values from NIST KAT-AES ECBVarKey192.rsp
  ...
  # Values from NIST KAT-AES ECBVarTxt256.rsp
  ...
  # Values from NIST KAT-AES ECBVarKey256.rsp
  ...
  # Values from NIST KAT-AES ECBVarTxt128.rsp, ECBVarTxt192.rsp and ECBVarTxt256.rsp
  plain_texts1 = [
      [ 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ],
      [ 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ],
      [ 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ],
  ...
  print("Testing AES-ECB 128-bit decryption\t"),
  result = True
  ...
  for test_index in range(0, 128):
    ...
    result = pycaes_test_crypt_ecb(
        pycaes.crypt_modes.DECRYPT, test_key, test_cipher_text, test_plain_text)
    if not result:
      break
  ...
  print("Testing AES-ECB 192-bit decryption\t"),
  result = True
  ...
  print("Testing AES-ECB 256-bit decryption\t"),
  result = True
