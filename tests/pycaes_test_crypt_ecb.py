...
class CryptEcbTest(unittest.TestCase):
    """Tests the crypt_ecb function."""
    ...
    def _test_pycaes_crypt_ecb(
        self, index, mode, key, input_data, expected_output_data
    ):
        """Test decrypting or encrypting data with pycaes.crypt_ecb."""
        caes_context = pycaes.context()
        caes_context.set_key(mode, key)

        output_data = pycaes.crypt_ecb(caes_context, mode, input_data)
    ...
    def test_aes_ecb_128bit_decryption(self):
        """Tests AES-ECB 128-bit decryption."""
    ...
    def test_aes_ecb_128bit_encryption(self):
        """Tests AES-ECB 128-bit encryption."""
    ...
    def test_aes_ecb_192bit_decryption(self):
        """Tests AES-ECB 192-bit decryption."""
    ...
    def test_aes_ecb_192bit_encryption(self):
        """Tests AES-ECB 192-bit encryption."""
    ...
    def test_aes_ecb_256bit_decryption(self):
        """Tests AES-ECB 256-bit decryption."""
    ...
    def test_aes_ecb_256bit_encryption(self):
        """Tests AES-ECB 256-bit encryption."""
