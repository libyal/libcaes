...
#if !defined( _LIBCAES_EXTERN_H )
#define _LIBCAES_EXTERN_H

/* To export functions from the libcaes DLL define LIBCAES_DLL_EXPORT
 * To import functions from the libcaes DLL define LIBCAES_DLL_IMPORT
