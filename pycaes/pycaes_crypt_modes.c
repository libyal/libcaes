...
PyTypeObject pycaes_crypt_modes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pycaes.crypt_modes",
	/* tp_basicsize */
	sizeof( pycaes_crypt_modes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pycaes_crypt_modes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pycaes crypt modes object (wraps LIBCAES_CRYPT_MODES)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_init */
	(initproc) pycaes_crypt_modes_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
